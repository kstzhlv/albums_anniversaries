...
def recallbum():
    ...
    web_parser = subparsers.add_parser(
        "parse",
        help="Parse the page of any AOTY user to get their favourite albums. Args: username, threshold (minimum rating to parse).",
    )
    ...
    reminder = subparsers.add_parser(
        "remind",
        help="Send a notification (or notifications) about today's albums anniversaries.",
    )
